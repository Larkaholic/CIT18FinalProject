    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8 -mt-4">
        ...
        <form action="{{ route('search') }}" method="get" class="relative z-10">
            <input
                ...
                class="text-sm md:text-md w-full md:p-4 rounded-md shadow-md focus:ring focus:ring-gray-900 text-gray-800 bg-gray-200"
            />
            <button type="submit" class="absolute right-4 md:top-4 sm:top-2 top-2">
